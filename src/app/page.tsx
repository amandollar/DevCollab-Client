  ...
  return (
    <div className="relative min-h-screen bg-gray-950 overflow-hidden">
      ...
      <section className="relative z-10 flex flex-col items-center px-4 text-center py-20 space-y-10">
        ...
        {/* Call to Action */}
        <button className="relative inline-flex h-12 overflow-hidden rounded-full p-[1px] focus:outline-none focus:ring-2 focus:ring-purple-400 focus:ring-offset-2 focus:ring-offset-slate-50 transition-transform hover:scale-105">
